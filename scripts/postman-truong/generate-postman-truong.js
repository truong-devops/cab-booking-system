...
const baseVariables = [
  ['baseUrl', 'http://localhost:42100'],
  ['httpsBaseUrl', 'https://localhost:42101'],
  ['authUrl', 'http://localhost:42102'],
  ['bookingUrl', 'http://localhost:42104'],
  ['driverUrl', 'http://localhost:42110'],
  ['etaUrl', 'http://localhost:42111'],
  ['pricingUrl', 'http://localhost:42106'],
  ['aiUrl', 'http://localhost:42112'],
  ['paymentUrl', 'http://localhost:42107'],
  ['notificationUrl', 'http://localhost:42109'],
  ['prometheusUrl', 'http://localhost:42191'],
  ['grafanaUrl', 'http://localhost:42190'],
